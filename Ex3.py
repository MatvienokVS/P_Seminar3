...
select_lang = int(input('For english press 1, Для русских нажмите 0: '))
word = input('Введите слово: ').upper()

abc_eng = {'A': 1, 'E': 1, 'I': 1, 'O': 1, 'U': 1, 'L': 1, 'N': 1, 'S': 1, 'T': 1, 'R': 1,
           'D': 2, 'G': 2,
           'B': 3, 'C': 3, 'M': 3, 'P': 3,
           'F': 4, 'H': 4, 'V': 4, 'W': 4, 'Y': 4,
           'K': 5,
...
abc_rus = {'А': 1, 'В': 1, 'Е': 1, 'И': 1, 'Н': 1, 'О': 1, 'Р': 1, 'С': 1, 'Т': 1,
